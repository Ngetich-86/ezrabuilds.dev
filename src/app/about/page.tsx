...
import { fadeInUp, fadeInLeft, fadeInRight, fadeInDown, staggerContainer } from "@/libs/animations";
import { useScrollAnimation } from "@/hooks/useScrollAnimation";

export default function AboutPage() {
    const { ref: headerRef, controls: headerControls } = useScrollAnimation();
    const { ref: contentRef, controls: contentControls } = useScrollAnimation();
    const { ref: educationRef, controls: educationControls } = useScrollAnimation();
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
            <div className="max-w-3xl mx-auto">
                ...
                <motion.div
                    ...
                    className="prose prose-lg prose-slate mb-12"
                >
                    <motion.p
                        variants={fadeInUp}
                        className="text-lg text-slate-600 mb-6 leading-relaxed"
                    >
                        I am a Full Stack Engineer with over 6 years of experience building scalable web applications.
